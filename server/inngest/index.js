...
//Inngest Function to upadate the database
...
// Ingest Function to save workspace data to database
...
const sendTaskAssignmentEmail = inngest.createFunction(
    ...
    async ({event,step}) => {
        ...
        await sendEmail({
            ...
            <div style="border: 1px solid #ddd; padding: 12px 16px; border-radius: 6px;
            margin-bottom: 30px;">
            <p style="margin: 60px 0;"><strong>Description:</strong> ${task.description}</p>
